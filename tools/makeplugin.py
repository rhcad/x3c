...
Usage:      makeplugin.py projname pkgname basetype
            ...
            pkgname: package name of the new project, the default value
                is 'pkg_Example'.
            basetype: 'mfc' or 'win32', the default value is 'win32'.
...
def makeproj(projname, pkgname, baseproj):
    ...
    copyfiles(basepath, destdir, pairs)
    ...
    copyfiles(projects, projects, pairs, matchfile)
...
if __name__=="__main__":
    ...
    baseproj = inputparam(3, 'Template project (win32|mfc): ', 'win32')
    if baseproj == 'win32':
        baseproj = 'Win32DllTempl'
    if baseproj == 'mfc':
        baseproj = 'MFCExtTempl'
